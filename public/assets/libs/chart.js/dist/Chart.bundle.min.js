...
!function (t, e) {
    ...
    var M, S = {
        noop: function () {
            ...
            var a, r, o;
            if (S.isArray(t)) if (r = t.length, i) for (a = r - 1; a >= 0; a--) e.call(n, t[a], a); else for (a = 0; a < r; a++) e.call(n, t[a], a); else if (S.isObject(t)) for (r = (o = Object.keys(t)).length, a = 0; a < r; a++) e.call(n, t[o[a]], o[a])
    ...
    D.easingEffects = C;
    var T = Math.PI, O = T / 180, A = 2 * T, F = T / 2, I = T / 4, L = 2 * T / 3, R = {
        clear: function (t) {
    ...
    var E = {
        toLineHeight: function (t, e) {
            ...
            var e = Y.global, n = z(t.fontSize, e.defaultFontSize), i = {
    ...
    var ht = X.extend({
        _type: "line", draw: function () {
            var t, e, n, i = this, a = i._view, r = i._chart.ctx, o = a.spanGaps, s = i._children.slice(), l = Y.global,
    ...
    var mt = X.extend({
        ...
        }, inLabelRange: gt, inXRange: gt, inYRange: function (t) {
            var e = this._view;
    ...
    function _t(t, e, n) {
        var i = null === e, a = null === n, r = !(!t || i && a) && bt(t);
    ...
    var wt = X.extend({
        _type: "rectangle", draw: function () {
            var t = this._chart.ctx, e = this._view, n = function (t) {
                var e = bt(t), n = e.right - e.left, i = e.bottom - e.top, a = xt(t, n / 2, i / 2);
                return {
    ...
    }), Y._set("global", {datasets: {bar: {categoryPercentage: .8, barPercentage: .9}}});
    var At = at.extend({
        ...
        calculateBarIndexPixels: function (t, e, n, i) {
            var a = "flex" === i.barThickness ? function (t, e, n) {
                ...
                }(e, n, i) : Ot(e, n, i), r = this.getStackIndex(t, this.getMeta().stack),
                o = a.start + a.chunk * r + a.chunk / 2, s = Math.min(Tt(i.maxBarThickness, 1 / 0), a.chunk * a.ratio);
        ...
        _resolveDataElementOptions: function () {
            var t = this, e = B.extend({}, at.prototype._resolveDataElementOptions.apply(t, arguments)),
    ...
    var Lt = at.extend({
        ...
        setHoverStyle: function (t) {
            var e = t._model, n = t._options, i = B.getHoverColor;
            t.$previousStyle = {
    ...
    Y._set("doughnut", {
        ...
        }, cutoutPercentage: 50, rotation: -Yt, circumference: Wt, tooltips: {
            callbacks: {
                title: function () {
                    return ""
                }, label: function (t, e) {
    ...
    var zt = at.extend({
        ...
        update: function (t) {
            ...
            if (p < Wt) {
                var b = l.rotation % Wt, y = (b += b >= Nt ? -Wt : b < -Nt ? Wt : 0) + p, x = Math.cos(b),
                    _ = Math.sin(b), w = Math.cos(y), k = Math.sin(y), M = b <= 0 && y >= 0 || y >= Wt,
                    S = b <= Yt && y >= Yt || y >= Wt + Yt, D = b <= -Yt && y >= -Yt || y >= Nt + Yt,
    ...
    }), Y._set("global", {datasets: {horizontalBar: {categoryPercentage: .8, barPercentage: .9}}});
    var Et = At.extend({
        _getValueScaleId: function () {
            return this.getMeta().xAxisID
        }, _getIndexScaleId: function () {
    ...
    var $t = at.extend({
        ...
        setHoverStyle: function (t) {
            var e = t._model, n = t._options, i = B.getHoverColor, a = B.valueOrDefault;
            t.$previousStyle = {
                backgroundColor: e.backgroundColor,
                borderColor: e.borderColor,
                borderWidth: e.borderWidth
    ...
    function re(t, e, n) {
        var i = te(e, t);
        n.axis = n.axis || "x";
        var a = ae(n.axis), r = n.intersect ? ne(t, i) : ie(t, i, !1, a), o = [];
    ...
    var oe = {
        modes: {
            ...
            }, label: re, index: re, dataset: function (t, e, n) {
                var i = te(e, t);
                n.axis = n.axis || "xy";
                var a = ae(n.axis), r = n.intersect ? ne(t, i) : ie(t, i, !1, a);
    ...
    var me, pe = {
            defaults: {}, addBox: function (t, e) {
                ...
                if (t) {
                    var i = t.options.layout || {}, a = B.options.toPadding(i.padding), r = e - a.width, o = n - a.height,
                        s = function (t) {
                            var e = function (t) {
                                    var e, n, i, a = [];
                                    ...
                                    return a
                                }(t), n = ue(le(e, "left"), !0), i = ue(le(e, "right")), a = ue(le(e, "top"), !0),
                                r = ue(le(e, "bottom"));
                            return {
        ...
        })) && me.default || me, be = "$chartjs", ye = "chartjs-size-monitor", xe = "chartjs-render-monitor",
        _e = "chartjs-render-animation", we = ["animationstart", "webkitAnimationStart"], ke = {
    ...
    function Me(t, e) {
        var n = B.getStyle(t, e), i = n && n.match(/^(\d+)(\.\d+)?px$/);
    ...
    function Oe(t, e, n) {
        var i, a, r, o, s = t[be] || (t[be] = {}), l = s.resizer = function (t) {
            var e = Te(ye), n = Te(ye + "-expand"), i = Te(ye + "-shrink");
        ...
        !function (t, e) {
            var n = t[be] || (t[be] = {}), i = n.renderProxy = function (t) {
    ...
    function Ae(t) {
        var e = t[be] || {}, n = e.resizer;
        delete e.resizer, function (t) {
            var e = t[be] || {}, n = e.renderProxy;
        ...
        addEventListener: function (t, e, n) {
            ...
            if ("resize" !== e) {
                ...
                De(i, e, (a.proxies || (a.proxies = {}))[t.id + "_" + e] = function (e) {
                    n(function (t, e) {
                        var n = ke[t.type] || t.type, i = B.getRelativePosition(t, e);
    ...
    Y._set("global", {
        tooltips: {
            ...
            borderWidth: 0,
            callbacks: {
                beforeTitle: B.noop, title: function (t, e) {
                    ...
                    return n
                }, afterTitle: B.noop, beforeBody: B.noop, beforeLabel: B.noop, label: function (t, e) {
    ...
    var ze = {
        average: function (t) {
            ...
            for (n = 0, i = t.length; n < i; ++n) {
                var l = t[n];
                if (l && l.hasValue()) {
                    var u = l.getCenterPoint(), d = B.distanceBetweenPoints(e, u);
                    d < s && (s = d, a = l)
                }
            }
            if (a) {
    ...
    var Ue = X.extend({
        initialize: function () {
            ...
            var e, n, i, a, r, o, s, l, u, d, h = this, c = h._options, f = h._model, g = h._model = He(c),
            ...
            var i, a, r, o, s, l, u, d, h = e.bodyFontSize, c = e.bodySpacing, f = e._bodyAlign, g = e.body,
                m = e.displayColors, p = 0, v = m ? Be(e, "left") : 0, b = Ye(e.rtl, e.x, e.width), y = function (e) {
    ...
    B.extend(en.prototype, {
        construct: function (t, e) {
            ...
            var i = Le.acquireContext(t, e), a = i && i.canvas, r = a && a.height, o = a && a.width;
            ...
            e.scales && (i = i.concat((e.scales.xAxes || []).map((function (t) {
                ...
                var i = e.options, r = i.id, o = Ze(i.type, e.dtype);
            ...
            var n = e.options.animation, i = Ze(t.duration, n && n.duration), a = t.lazy;
                ...
                if (n && i) {
                    var o = new J({
                        numSteps: i / 16.66, easing: t.easing || n.easing, render: function (t, e) {
                            var n = B.easing.effects[e.easing], i = e.currentStep, a = i / e.numSteps;
                            t.draw(n(a), a, i)
    ...
    var on = {_date: rn}, sn = {
        formatters: {
            values: function (t) {
                ...
                var a = B.log10(Math.abs(i)), r = "";
                if (0 !== t) if (Math.max(Math.abs(n[0]), Math.abs(n[n.length - 1])) < 1e-4) {
                    var o = B.log10(Math.abs(t)), s = Math.floor(o) - Math.floor(a);
    ...
    var xn = X.extend({
        zeroLineIndex: 0, getPadding: function () {
        ...
        }, buildTicks: B.noop, afterBuildTicks: function (t) {
            var e = this;
            ...
            if (u ? e.width = t.maxWidth : s && (e.width = gn(o) + mn(r)), u ? s && (e.height = gn(o) + mn(r)) : e.height = t.maxHeight, a.display && s) {
                var d = vn(a), h = t._getLabelSizes(), c = h.first, f = h.last, g = h.widest, m = h.highest,
                    p = .4 * d.minor.lineHeight, v = a.padding;
                if (u) {
                    var b = 0 !== t.labelRotation, y = B.toRadians(t.labelRotation), x = Math.cos(y), _ = Math.sin(y),
        ...
        }, getLabelForIndex: B.noop, getPixelForValue: B.noop, getValueForPixel: B.noop, getPixelForTick: function (t) {
            ...
            var e, n, i, a, r, o, s, l, u, d, h, c, f, g, m, p, v, b = this, y = b.chart, x = b.options,
                ...
                D = S.length + (k ? 1 : 0), C = gn(_), P = [], T = _.drawBorder ? hn(_.lineWidth, 0, 0) : 0, O = T / 2,
                A = B._alignPixel, F = function (t) {
                    return A(y, t, T)
                };
            ...
            var t, e, n, i, a, r, o, s, l, u, d, h, c = this, f = c.options, g = f.ticks, m = f.position, p = g.mirror,
                v = c.isHorizontal(), b = c._ticksToDraw, y = vn(g), x = g.padding, _ = gn(f.gridLines),
                w = -B.toRadians(c.labelRotation), k = [];
            ...
            if (n.display) {
                var i, a, r, o, s, l = e.ctx, u = e.chart, d = B._alignPixel,
            ...
            if (i.display) {
                var a, r, o = dn(i.fontColor, Y.global.defaultFontColor), s = B.options._parseFont(i),
                    l = B.options.toPadding(i.padding), u = s.lineHeight / 2, d = n.position, h = 0;
    ...
    var _n = xn, wn = B.isNullOrUndef, kn = _n.extend({
    ...
    var Cn = _n.extend({
        getRightValue: function (t) {
            ...
            if (e.beginAtZero) {
                var n = B.sign(t.min), i = B.sign(t.max);
            ...
            var t = this, e = t.options.ticks, n = t.getTickLimit(), i = {
                ...
                var n, i, a, r, o = [], s = t.stepSize, l = s || 1, u = t.maxTicks - 1, d = t.min, h = t.max,
                    c = t.precision, f = e.min, g = e.max, m = B.niceNum((g - f) / u / l) * l;
    ...
    var Wn = _n.extend({
        determineDataLimits: function () {
            ...
            var t = this, e = t.options.ticks, n = !t.isHorizontal(), i = {min: Nn(e.min), max: Nn(e.max)},
                a = t.ticks = function (t, e) {
                    var n, i, a = [], r = In(t.min, Math.pow(10, Math.floor(Ln(e.min)))), o = Math.floor(Ln(e.max)),
    ...
    Wn._defaults = Yn;
    var zn = B.valueOrDefault, En = B.valueAtIndexOrDefault, Vn = B.options.resolve, Hn = {
        display: !0,
        animate: !0,
        position: "chartArea",
        ...
        setDimensions: function () {
            ...
            t.display && t.pointLabels.display ? function (t) {
                ...
                for (e = 0; e < d; e++) {
                    ...
                    var h = t.getIndexAngle(e), c = B.toDegrees(h) % 360, f = jn(c, i.x, n.w, 0, 180),
            ...
            var t, e, n, i = this, a = i.ctx, r = i.options, o = r.gridLines, s = r.angleLines,
                l = zn(s.lineWidth, o.lineWidth), u = zn(s.color, o.color);
            if (r.pointLabels.display && function (t) {
                var e = t.ctx, n = t.options, i = n.pointLabels, a = Bn(n),
                    r = t.getDistanceFromCenterForValue(n.ticks.reverse ? t.min : t.max), o = B.options._parseFont(i);
                ...
                for (var s = t.chart.data.labels.length - 1; s >= 0; s--) {
                    ...
                    e.fillStyle = d;
                    var h = t.getIndexAngle(s), c = B.toDegrees(h);
            ...
            if (n.display) {
                var i, a, r = t.getIndexAngle(0), o = B.options._parseFont(n),
    ...
    $n._defaults = Xn;
    var Kn = B._deprecated, Jn = B.options.resolve, Qn = B.valueOrDefault,
        ti = Number.MIN_SAFE_INTEGER || -9007199254740991, ei = Number.MAX_SAFE_INTEGER || 9007199254740991, ni = {
    ...
    function ui(t, e) {
        ...
        var n = t.options.time, i = li(t, t.getRightValue(e));
    ...
    var ci = _n.extend({
        initialize: function () {
            ...
            var t = this, e = t.options, n = e.time || (e.time = {}), i = t._adapter = new on._date(e.adapters.date);
            ...
            var t, e, n, i, a, r, o, s = this, l = s.chart, u = s._adapter, d = s.options, h = d.time.unit || "day",
                c = ei, f = ti, g = [], m = [], p = [], v = s._getLabels();
            for (t = 0, n = v.length; t < n; ++t) p.push(ui(s, v[t]));
            for (t = 0, n = (l.data.datasets || []).length; t < n; ++t) if (l.isDatasetVisible(t)) if (a = l.data.datasets[t].data, B.isObject(a[0])) for (m[t] = [], e = 0, i = a.length; e < i; ++e) r = ui(s, a[e]), g.push(r), m[t][e] = r; else m[t] = p.slice(0), o || (g = g.concat(p), o = !0); else m[t] = [];
            ...
            for (u = "data" === c || "auto" === c && "series" === f ? u.data : "labels" === c ? u.labels : function (t, e, n, i) {
                var a, r = t._adapter, o = t.options, s = o.time, l = s.unit || di(s.minUnit, e, n, i),
                    u = Jn([s.stepSize, s.unitStepSize, 1]), d = "week" === l && s.isoWeekday, h = e, c = [];
            ...
            var a = this._adapter, r = this.options, o = r.time.displayFormats, s = o[this._unit], l = this._majorUnit,
                ...
                g = c ? h.major : h.minor, m = Jn([g.callback, g.userCallback, h.callback, h.userCallback]);
            return m ? m(f, e, n) : f
            ...
            var e = this._offsets, n = si(this._table, "time", t, "pos");
            ...
            var e = this.options.ticks, n = this.ctx.measureText(t).width,
                i = B.toRadians(this.isHorizontal() ? e.maxRotation : e.minRotation), a = Math.cos(i), r = Math.sin(i),
            ...
            var e = this, n = e.options.time, i = n.displayFormats, a = i[n.unit] || i.millisecond,
                r = e.tickFormatFunction(t, 0, hi(e, [t], e._majorUnit), a), o = e._getLabelSize(r),
    ...
    ci._defaults = fi;
    var gi = {category: kn, linear: An, logarithmic: Wn, radialLinear: $n, time: ci}, mi = e((function (e, n) {
        e.exports = function () {
            var n, i;
    ...
    var Oi = X.extend({
        initialize: function (t) {
        ...
        }, beforeUpdate: Ci, update: function (t, e, n) {
            var i = this;
            ...
            var t = this, e = t.options, n = e.labels, i = e.display, a = t.ctx, r = B.options._parseFont(n),
            ...
            var t = this, e = t.options, n = e.labels, i = Y.global, a = i.defaultColor, r = i.elements.line,
                o = t.height, s = t.columnHeights, l = t.width, u = t.lineWidths;
            if (e.display) {
                var d, h = Di(e.rtl, t.left, t.minSize.width), c = t.ctx, f = Pi(n.fontColor, i.defaultFontColor),
                    g = B.options._parseFont(n), m = g.size;
                c.textAlign = h.textAlign("left"), c.textBaseline = "middle", c.lineWidth = .5, c.strokeStyle = f, c.fillStyle = f, c.font = g.string;
                var p = Ti(n, m), v = t.legendHitBoxes, b = function (t, i) {
                    switch (e.align) {
                        case"start":
                            return n.padding;
                        case"end":
    ...
    var Fi = {
        id: "legend", _element: Oi, beforeInit: function (t) {
    ...
    var Li = X.extend({
        ...
        draw: function () {
            ...
            if (n.display) {
                var i, a, r, o = B.options._parseFont(n), s = o.lineHeight, l = s / 2 + n.padding, u = 0, d = t.top,
    ...
    var Ni = {}, Wi = Si, Yi = Fi, zi = {
        id: "title", _element: Li, beforeInit: function (t) {
    ...
    for (var Ei in Ni.filler = Wi, Ni.legend = Yi, Ni.title = zi, nn.helpers = B, function () {
        ...
        function n(n, i, a) {
            var r = document.defaultView, o = B._getParentNode(n), s = r.getComputedStyle(n)[i],
        ...
        B.where = function (t, e) {
            ...
            var n = Math.floor(B.log10(t)), i = t / Math.pow(10, n);
            ...
            var l = parseFloat(B.getStyle(r, "padding-left")), u = parseFloat(B.getStyle(r, "padding-top")),
                d = parseFloat(B.getStyle(r, "padding-right")), h = parseFloat(B.getStyle(r, "padding-bottom")),
