    ...
    <div class="container-fluid mt-4">
        <div class="row">
            <div class="col-6 offset-3">
                <form action="{{route('devices.store')}}; upload" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="form-group">
                        <label for="type" style="color: white">Type de matériel : </label>
                    ...
                    <div class="form-group">
                        <label for="serialNumber" style="color: white">Numéro de série : </label>
                        <input type="text" name="serialNumber" class="form-control" required>
                    </div>

                    <div class="form-group">
                        <label for="productReference" style="color: white">Référence du matériel : </label>
                        <input type="text" name="productReference" class="form-control" required>
                    </div>

                    <div class="form-group">
                        <label for="europeanNorm" style="color: white">Norme européenne ? </label>
                        <input onclick="showPictureEuropeanNorm()" type="radio" value="1" id="isEuropeanNorm"
                               name="europeanNorm" required>
                        <label for="europeanNorm">Oui</label>
                        <input onclick="hidePictureEuropeanNorm()" type="radio" value="0" id="isNotEuropeanNorm"
                               name="europeanNorm" required>
                    ...
                    <div class="form-group" id="europeanNormPicture">
                        <label for="europeanNormPicture" style="color: white">Photo de la plaquette CE : </label>
                        <input type="file" class="form-control" name="europeanNormPicture" id="europeanNormPicture"/>
                    ...
                    <div class="form-group">
                        <label for="available" style="color: white">Est-il disponible ? </label>
                        <input onclick="hideAvailable()" type="radio" value="1" id="isAvailable" name="available"
                               required>
                        <label for="available">Oui</label>
                        <input onclick="showAvailable()" type="radio" value="0" id="isNotAvailable" name="available"
                               required>
                        <label for="available">Non</label>
                    </div>

                    <div class="form-group" id="customer">
                        <label for="customer" style="color: white">Propriétaire du matériel : </label>
                    ...
                    <div class="form-group" id="saleDate">
                        <label for="saleDate" style="color: white">Date de vente : </label>
                        <input type="date" name="saleDate" id="saleDate" class="form-control">
                    </div>

                    <div class="form-group" id="installationDate">
                        <label for="installationDate" style="color: white">Date d'installation : </label>
                        <input type="date" name="installationDate" id="installationDate" class="form-control">
                    </div>

                    <div class="form-group" id="installationPicture">
                        <label for="installationPicture" style="color: white">Photo de l'installation : </label>
                        <input type="file" name="image" id="image" value="">
                    </div>

                    <div class="form-group" id="contract">
                        <label for="contract" style="color: white">Durée du contrat : </label>
                        <input type="number" name="contract" min="0" max="5" class="form-control" required>
                    </div>

                    <div class="form-group" id="technician">
                        <label for="technician" style="color: white">Qui a installé ce matériel ? </label>
