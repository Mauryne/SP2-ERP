            ...
            <div class="col-6 offset-3">
                <form action="{{route('devices.store')}}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input onclick="showPictureEuropeanNorm()" type="radio" value="1" id="isEuropeanNorm" name="europeanNorm" required>
                        <label for="europeanNorm">Oui</label>
                        <input onclick="hidePictureEuropeanNorm()" type="radio" value="0" id="isNotEuropeanNorm" name="europeanNorm" required>
...
{{--                        </div>--}}
                    ...
                    <div class="form-group">
                        ...
                        <input onclick="hideAvailable()" type="radio" value="1" id="isAvailable" name="available" required>
                        <label for="available">Oui</label>
                        <input onclick="showAvailable()" type="radio" value="0" id="isNotAvailable" name="available" required>
